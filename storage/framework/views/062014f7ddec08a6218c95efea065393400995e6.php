      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="pull-right">
            <a href="<?php echo e(route('tag.create')); ?>" class="btn btn-primary">Add New</a>
          </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td><a href="<?php echo e(route('tag.edit',$tag->id)); ?>" class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
              <form action="<?php echo e(route('tag.destroy',$tag->id)); ?>" id="delete-form-<?php echo e($tag->id); ?>" method="post">
