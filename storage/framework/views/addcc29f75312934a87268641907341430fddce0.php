      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="pull-right">
            <a href="<?php echo e(route('permission.create')); ?>" class="btn btn-primary">Add New</a>
          </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td><a href="<?php echo e(route('permission.edit',$permission->id)); ?>" class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
              <form action="<?php echo e(route('permission.destroy',$permission->id)); ?>" id="delete-form-<?php echo e($permission->id); ?>" method="post">
